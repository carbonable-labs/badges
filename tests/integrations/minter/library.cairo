...
func setup{syscall_ptr: felt*, pedersen_ptr: HashBuiltin*, range_check_ptr}() {
    ...
    %{
        ...
        context.minter.class_hash = declare(
            contract=context.sources.minter
        ).class_hash
        context.minter.contract_address = deploy_contract(
            contract=context.sources.proxy,
            constructor_args={
                "implementation_hash": context.minter.class_hash,
                "selector": context.selector.initializer,
                "calldata": {
                    "signer_key": context.minter.public_key,
    ...
    %{
        ...
        ids.badge_minter_contract_address = context.minter.contract_address
    %}
