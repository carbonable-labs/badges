...
func initializer{syscall_ptr: felt*, pedersen_ptr: HashBuiltin*, range_check_ptr}(
    ...
    CarbonableMinter.initializer(signer_key, carbonable_badge_contract_address);
...
func getSignerPublicKey{syscall_ptr: felt*, pedersen_ptr: HashBuiltin*, range_check_ptr}() -> (
    ...
    return CarbonableMinter.getSignerPublicKey();
}
...
func getBadgeContractAddress{syscall_ptr: felt*, pedersen_ptr: HashBuiltin*, range_check_ptr}() -> (
    ...
    return CarbonableMinter.getBadgeContractAddress();
}
...
func claim{
    ...
    CarbonableMinter.assert_valid_signature((caller_address, badge_type), signature);
    CarbonableMinter.claim(badge_type);
    return ();
}
...
func setSignerPublicKey{syscall_ptr: felt*, pedersen_ptr: HashBuiltin*, range_check_ptr}(
    ...
    CarbonableMinter.setSignerPublicKey(new_signer_public_key);
    return ();
}
...
func setBadgeContractAddress{syscall_ptr: felt*, pedersen_ptr: HashBuiltin*, range_check_ptr}(
    ...
    Ownable.assert_only_owner();
    CarbonableMinter.setBadgeContractAddress(new_badge_contract_address);
    return ();
}
...
func transferBadgeContractOwnership{
    ...
    Ownable.assert_only_owner();
    CarbonableMinter.transferBadgeContractOwnership(newOwner);
    return ();
}
